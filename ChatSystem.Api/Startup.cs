using ChatSystem.DatabaseAccess;
...
namespace ChatSystem.Api
{
    public class Startup
    {
        ...
        {
            services.AddChatSystemDomain();
            services.AddChatSystemDatabaseAccess(Configuration["ConnectionStrings:DefaultConnection"], inMemory:true);
